...
ggsave(filename = "accuracy.pdf", width=7, scale=0.8)
...
ggplot(validation, aes(variable, number)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black"))
ggsave(filename = "validation.pdf", width=3,scale=0.8)
...
ggplot(validation2, aes(variable, number)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black"))
ggsave(filename = "validation2.pdf", width=2.2,scale=0.8)
```
...
ggplot(human_effort, aes(max_label, value)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black")) +
  scale_fill_grey(start = 0.6, end = .9)
ggsave(filename = "effort2.pdf",scale=0.8)
...
ggplot(human_effort2, aes(max_label, value)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black")) +
  scale_fill_grey(start = 0.6, end = .9)
ggsave(filename = "effort1.pdf",scale=0.8)
...
for (i in 0:9) {
  ...
  for (Subject in levels(factor(d$V1))){
    specific = subset(d, V1 == Subject & V2 > i*3 & V2 <= i*3+3)
...
ggplot(patch_quality, aes(variable, value)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black")) +
  scale_fill_grey(start = 0.6, end = .9)
ggsave(filename = "repairability.pdf",scale=0.7)
```
...
patch_quality3 = data.frame(subject=c(d_10_manual$V1,d_10_autogen$V1,
                                      d_20_autogen$V1,d_30_autogen$V1),
                            max_label = c(rep("Validation Score", nrow(d_10_manual)),
                                          rep("Validation Score", nrow(d_10_autogen)),
                                          rep("Validation Score", nrow(d_20_autogen)),
                                          rep("Validation Score", nrow(d_30_autogen))),
                            variable = c(rep("Manual", nrow(d_10_manual)),
                                         rep("10", nrow(d_10_autogen)),
                                         rep("20", nrow(d_20_autogen)),
                                         rep("30", nrow(d_30_autogen))),
...
ggplot(patch_quality3, aes(variable, value)) +
  ...
  theme(legend.position="none", legend.title= element_blank(),
        axis.text.x = element_text(colour = "black"), axis.text.y = element_text(colour = "black")) +
  scale_fill_grey(start = 0.6, end = .9)
ggsave(filename = "patchquality.pdf",scale=0.7)
```